export const THEMES = {
    ...
    DUSTY_ORCHID: {
        ...
        primaryForeground: "#ffffff",
        secondary: "#f3e8f0",
        secondaryForeground: "#b24c7c",
        muted: "#f8f0f6",
        mutedForeground: "#948491",
        accent: "#3aa6a6",
    ...
    CITRUS_SLATE: {
        ...
        secondary: "#242d38",
        secondaryForeground: "#ff7a2f",
        muted: "#1c252f",
        mutedForeground: "#8e9ba8",
        accent: "#7dd3ff",
    ...
    MOSS_PARCHMENT: {
        ...
        foreground: "#2a342e",
        card: "#ffffff",
        cardForeground: "#2a342e",
        popover: "#ffffff",
        popoverForeground: "#2a342e",
        primary: "#2f7d4a",
        primaryForeground: "#ffffff",
        secondary: "#e8edea",
        secondaryForeground: "#2f7d4a",
        muted: "#eff2f0",
        mutedForeground: "#75857a",
        accent: "#b26d2d",
        accentForeground: "#ffffff",
        destructive: "#991b1b",
        border: "#d9e0db",
    ...
    POLAR_MINT: {
        ...
        foreground: "#003d3d",
        card: "#ffffff",
        cardForeground: "#003d3d",
        popover: "#ffffff",
        popoverForeground: "#003d3d",
        primary: "#00a6a6",
        primaryForeground: "#ffffff",
        secondary: "#e0f2f2",
        secondaryForeground: "#00a6a6",
        muted: "#ecf7f7",
    ...
    CRIMSON_DUSK: {
        ...
        primaryForeground: "#ffffff",
        secondary: "#3d1414",
        secondaryForeground: "#ff4d4d",
        muted: "#301010",
        mutedForeground: "#a87d7d",
        accent: "#ff9e9e",
        accentForeground: "#1a0505",
        destructive: "#ffffff",
        border: "#4a1c1c",
        input: "#4a1c1c",
        ring: "#ff4d4d",
    ...
    GOLDEN_HOUR: {
        ...
        muted: "#302506",
        mutedForeground: "#998a65",
        accent: "#fbbf24",
        accentForeground: "#171202",
        destructive: "#ef4444",
        border: "#4b3b0a",
        input: "#4b3b0a",
        ring: "#f59e0b",
