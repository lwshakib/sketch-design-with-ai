...
export function SecondarySidebar({ commitEdits }: SecondarySidebarProps) {
  ...
  return (
    <aside className="bg-card/95 border-border/50 animate-in slide-in-from-right absolute inset-y-0 right-0 z-[100] flex w-[320px] flex-col border-l shadow-2xl backdrop-blur-3xl duration-300">
