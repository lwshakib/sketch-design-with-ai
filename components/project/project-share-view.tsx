...
export function ProjectShareView({
  ...
  const firstWidth = firstArtifact
    ? firstArtifact.width || (firstArtifact.type === "app" ? 380 : 1280)
    : 0;
  const centeringOffset = firstArtifact
    ? -(firstArtifact.x || 0) - firstWidth / 2
    : 0;
    ...
    <div className="flex min-h-screen w-full flex-col bg-zinc-950 font-sans text-white">
      ...
      <header className="sticky top-0 z-50 flex h-16 items-center justify-between border-b border-zinc-800 bg-zinc-950/80 px-6 backdrop-blur-xl">
        <div className="flex items-center gap-4">
          ...
          <h1 className="max-w-[400px] truncate text-lg font-bold tracking-tight text-white">
            {project.title}
          </h1>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <Button
            ...
            className="h-9 gap-2 rounded-full bg-zinc-100 px-6 text-xs font-semibold text-black shadow-lg transition-all hover:bg-white"
          >
            {hasCopied ? (
          ...
          >
            {artifacts.map((artifact, index) => (
              ...
              >
                <div
                  className={cn(
                    "group relative flex flex-col overflow-hidden border shadow-[0_40px_100px_rgba(0,0,0,0.4)] transition-all duration-300 ease-out",
          ...
          <div className="flex flex-col items-center justify-center gap-8 p-8">
            <div className="flex flex-col items-center gap-2">
              ...
              <p className="text-xs text-zinc-500">
                Open this preview on your device
              </p>
            </div>
